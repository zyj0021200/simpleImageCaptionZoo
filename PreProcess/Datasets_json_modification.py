...
if __name__ == '__main__':
    ...
    parser.add_argument('--tokenizer',type=str,default='PTB',help='choose from "PTB/nltk/nltk_punc/karpathy", the PTB tokenizer is the same tokenizer used in cocoeval API, other tokenizers like nltk and also the karpathy- preprocessed tokens can be chosen here.')
    parser.add_argument('--overwrite',type=bool,default=True,help='when this option is True, the modification process will overwrite the previously modified results.')
